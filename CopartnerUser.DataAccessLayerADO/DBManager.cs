...
namespace CopartnerUser.DataAccessLayerADO
{
    public class DBManager
    {
        ...
        public DBManager(IConfiguration configuration, string connectionStringName, string providerName)
        {
            dbFactory = new DatabaseHandlerFactory(configuration, connectionStringName, providerName);
            database = dbFactory.CreateDatabase();
            this.providerName = dbFactory.GetProviderName();
        }
